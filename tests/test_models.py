...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        self.dataset, user_item_encodings = preprocess_and_split(
            data, random_state=self.seed
        )
    ...
    def test_svd(self):
        ...
        model = SVD(
            self.num_users, self.num_movies, self.global_mean, random_state=self.seed
        )
